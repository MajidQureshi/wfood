<div class="col-sm-12">
    ...
    <div class="col-md-3">
        ...
        <input type="text" class="form-control" id="min_qty" name="min_qty" placeholder="Minimum Qty" value="<?php echo $productmains[0]['min_qty']; ?>">
        <label class="col-sm-6">Max Qty</label>
        <input type="text" class="form-control" id="max_qty" name="max_qty" placeholder="Maximum Qty" value="<?php echo $productmains[0]['max_qty']; ?>">
        <label class="col-sm-6">Reorder Level Quantity</label>
        <input type="text" class="form-control" id="re_order_level_qty" name="re_order_level_qty" placeholder="Reorder Level Qty" value="<?php echo $productmains[0]['re_order_level_qty']; ?>">

        <label class="col-sm-6">Min Order Qty</label>
        <input type="text" class="form-control" id="min_order_qty" name="min_order_qty" placeholder="Minimum Order Qty" value="<?php echo $productmains[0]['min_order_qty']; ?>">
        <label class="col-sm-6">Max Order Qty</label>
        <input type="text" class="form-control" id="max_order_qty" name="max_order_qty" placeholder="Maximum Order Qty" value="<?php echo $productmains[0]['max_order_qty']; ?>">
        <label class="col-sm-6">PO Quantity Tolerence</label>
        <input type="text" class="form-control" id="po_qty_tolerence" name="po_qty_tolerence" placeholder="PO Qty Tolerence" value="<?php echo $productmains[0]['po_qty_tolerence']; ?>">
    </div>
    <div class="col-md-3">
        ...
        <label class="col-sm-6">Catalog/Design No</label>
        <input type="text" class="form-control" id="catalog_design" name="catalog_design" placeholder="Catalog/Design No" value="<?php echo $productmains[0]['catalog_design']; ?>">
        <label class="col-sm-6">Article/Part No</label>
        <input type="text" class="form-control" id="article_part" name="article_part" placeholder="Article/Part No" value="">
        <label class="col-sm-6">Registration</label>
        <input type="text" class="form-control" id="registration" name="registration" placeholder="Registration" value="<?php echo $productmains[0]['registration']; ?>">
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        ...
        <input id="is_imported" name="is_imported" value="1" type="checkbox" checked=""> Is Imported
                <br>
        <input id="is_purchaseable" value="1" name="is_purchaseable" type="checkbox" checked=""> Is Purchaseable
        <br>
        <input id="is_saleable" value="1" name="is_saleable" type="checkbox" checked=""> Is Saleable
        <br>
        <input id="is_asset" name="is_asset" value="1" type="checkbox" checked=""> Is Asset
        <br>
        <input id="maintain_inventory" value="1" name="maintain_inventory" type="checkbox" checked=""> Maintain Inventory
        <br>
        <input id="maintain_serial" value="1" name="maintain_serial" type="checkbox" checked=""> Maintain Serial
        <br>
        <input id="maintain_batch" value="1" name="maintain_batch" type="checkbox" checked=""> Maintain Batch
        <br>
