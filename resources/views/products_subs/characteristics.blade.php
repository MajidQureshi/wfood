...
.table-title .add-new-characteristics {
    float: right;
    height: 30px;
    font-weight: bold;
    font-size: 12px;
...
.table-title .add-new-characteristics i {
    margin-right: 4px;
}
table.table {
    table-layout: fixed;
...
$(document).ready(function(){
    ...
    $(".add-new-characteristics").click(function(){
        ...
        var row = '<tr>' +
            ...
            '</td>'+
            '<td>'+
            '<input type="text" class="form-control" name="ch_short_name[]">'+
            '</td>'+
            '<td>'+
            '<input type="text" class="form-control" name="ch_sort_by[]">'+
            '</td>'+
            '<td>'+
            '<input type="text" class="form-control" name="ch_value[]">'+
            '</td>'+
            '<td>'+
            '<input type="text" class="form-control" name="ch_is_active[]">'+
            '</td>'+
            '<td>' + actions + '</td>' +
        '</tr>';
    ...
    $(document).on("click", ".add", function(){
        ...
        if(!empty){
            ...
            $(".add-new-characteristics").removeAttr("disabled");
        }       
    });
...
<div class="container-lg">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Characteristics</h2></div>
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-info add-new-characteristics"><i class="fa fa-plus"></i> Add New</button>
                    </div>
                </div>
            </div>
    <div class="table-responsive" style="overflow-y: auto;height: 300px; overflow-y: visible;">
            ...
            <table class="table" id="characteristics">
                <thead>
                    <tr>
