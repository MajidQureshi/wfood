...
trait ShopCreateOperation
{
    ...
    protected function setupCreateRoutes($segment, $routeName, $controller)
    {
        ...
        Route::get($segment.'/createshopchild', [
            'as'        => $routeName.'.createshopchild',
            'uses'      => $controller.'@createshopchild',
            'operation' => 'create',
        ]);
    ...
    public function createshopchild()
    {
        $this->crud->hasAccessOrFail('create');
        ...
        // return view($this->crud->getCreateView(), $this->data);
        return view("crud::createshopchild", $this->data);
